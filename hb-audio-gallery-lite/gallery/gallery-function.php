    ...
    <div id="hb-ag-setting" class="wrap" style="width:900px;">
        ...
        <?php if( $remote_pay_version != 'pay' ) { ?>
            ...
            <div id="hb-update-message" class="hb-update-message">
                <p>This plugin is lite version. Audio download, Audio sharing and Scan files functions are not available in lite version.
                    If you want to use these function, please download <a href="http://audio.hbwebsol.com/demo/">paid version</a>.</p>
            </div>
        <?php } ?>
